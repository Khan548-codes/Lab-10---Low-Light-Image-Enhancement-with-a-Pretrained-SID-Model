...
I_noisy = imnoise(I_dark, "gaussian", 0, 0.002); % Add noise

% Rename the variable I to I_original for clarity in step 9
I_original = I; 
I = I_noisy; % Use the noisy image as the input for the network preparation
...
% *** Improvement suggestion: Add imadjust here for better contrast ***
% out = imadjust(out); 
